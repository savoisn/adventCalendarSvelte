...
var app = (function () {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(button, file$4, 99, 2, 2175);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h1, file$4, 111, 2, 2554);
    			attr_dev(h2, "class", "svelte-1dhn3qf");
    			add_location(h2, file$4, 112, 2, 2574);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	door = new Door({
    			props: {
    				imagePath: /*doorNumber*/ ctx[16].reward.imagePath,
    				rewardLink: /*doorNumber*/ ctx[16].reward.rewardLink,
    				doorNumber: /*doorNumber*/ ctx[16].day,
    				doorOpen: /*doorNumber*/ ctx[16].day <= /*$doorStore*/ ctx[3],
    				canOpen: /*canOpen*/ ctx[5],
    				isAlreadyOpened: /*isAlreadyOpened*/ ctx[6],
    				doorId: /*doorNumber*/ ctx[16].id,
    				size: "small",
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const door_changes = {};
    			if (dirty & /*calendarDays*/ 2) door_changes.imagePath = /*doorNumber*/ ctx[16].reward.imagePath;
    			if (dirty & /*calendarDays*/ 2) door_changes.rewardLink = /*doorNumber*/ ctx[16].reward.rewardLink;
    			if (dirty & /*calendarDays*/ 2) door_changes.doorNumber = /*doorNumber*/ ctx[16].day;
    			if (dirty & /*calendarDays, $doorStore*/ 10) door_changes.doorOpen = /*doorNumber*/ ctx[16].day <= /*$doorStore*/ ctx[3];
    			if (dirty & /*calendarDays*/ 2) door_changes.doorId = /*doorNumber*/ ctx[16].id;
    			door.$set(door_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(a0, file$4, 102, 8, 2247);
    			attr_dev(h1, "class", "svelte-1dhn3qf");
    			add_location(h1, file$4, 102, 1, 2240);
    			attr_dev(p0, "class", "svelte-1dhn3qf");
    			add_location(p0, file$4, 103, 1, 2322);
    			attr_dev(p1, "class", "svelte-1dhn3qf");
    			add_location(p1, file$4, 105, 1, 2366);
    			attr_dev(p2, "class", "svelte-1dhn3qf");
    			add_location(p2, file$4, 106, 1, 2438);
    			attr_dev(p3, "class", "svelte-1dhn3qf");
    			add_location(p3, file$4, 108, 1, 2506);
    			attr_dev(div0, "class", "box svelte-1dhn3qf");
    			add_location(div0, file$4, 115, 1, 2607);
    			attr_dev(p4, "class", "svelte-1dhn3qf");
    			add_location(p4, file$4, 132, 1, 3010);
    			attr_dev(p5, "class", "svelte-1dhn3qf");
    			add_location(p5, file$4, 134, 1, 3209);
    			add_location(div1, file$4, 131, 1, 3003);
    			add_location(br, file$4, 137, 1, 3302);
    			attr_dev(p6, "class", "svelte-1dhn3qf");
    			add_location(p6, file$4, 138, 1, 3309);
    			attr_dev(a1, "class", "link svelte-1dhn3qf");
    			attr_dev(a1, "href", "/Changelog");
    			add_location(a1, file$4, 139, 29, 3425);
    			attr_dev(p7, "class", "svelte-1dhn3qf");
    			add_location(p7, file$4, 139, 1, 3397);
    			add_location(button, file$4, 140, 0, 3482);
    			add_location(div2, file$4, 136, 0, 3295);
    			attr_dev(main, "class", "svelte-1dhn3qf");
    			add_location(main, file$4, 96, 0, 2150);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(nav, file$9, 29, 1, 816);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$9, 36, 1, 946);
    		},
    		m: function mount(target, anchor) {
    			if (if_block) if_block.m(target, anchor);
