    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 79, 1, 2105);
    			add_location(p0, file$1, 80, 1, 2142);
    			add_location(p1, file$1, 82, 1, 2184);
    			add_location(p2, file$1, 83, 1, 2256);
    			add_location(p3, file$1, 85, 1, 2325);
    			attr_dev(div0, "class", "box svelte-1dpsacs");
    			add_location(div0, file$1, 87, 1, 2352);
    			add_location(p4, file$1, 100, 1, 2699);
    			add_location(p5, file$1, 102, 1, 2898);
    			add_location(div1, file$1, 99, 1, 2692);
    			add_location(button, file$1, 104, 5, 2989);
    			add_location(div2, file$1, 104, 0, 2984);
    			attr_dev(main, "class", "svelte-1dpsacs");
    			add_location(main, file$1, 78, 0, 2097);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
