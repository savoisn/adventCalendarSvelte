...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "bgSpan svelte-1tdtiqv");
    			add_location(span, file, 35, 10, 855);
    			attr_dev(div0, "class", "backgroundText svelte-1tdtiqv");
    			add_location(div0, file, 34, 8, 816);
    			attr_dev(div1, "class", "backgroundPicture svelte-1tdtiqv");
    			add_location(div1, file, 33, 6, 776);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*rewardText*/ ctx[3]);
    			attr_dev(span, "class", "bgSpan svelte-1tdtiqv");
    			add_location(span, file, 26, 12, 646);
    			attr_dev(div0, "class", "backgroundText svelte-1tdtiqv");
    			add_location(div0, file, 25, 10, 605);
    			attr_dev(div1, "class", "backgroundPicture svelte-1tdtiqv");
    			add_location(div1, file, 24, 8, 563);
    			attr_dev(a, "href", /*rewardLink*/ ctx[4]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-1tdtiqv");
    			add_location(a, file, 23, 6, 517);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "doorNumber svelte-1tdtiqv");
    			add_location(span, file, 44, 6, 1058);
    			attr_dev(div0, "class", "door svelte-1tdtiqv");
    			toggle_class(div0, "doorOpen", /*doorOpen*/ ctx[0]);
    			add_location(div0, file, 41, 4, 962);
    			attr_dev(div1, "class", "backDoor svelte-1tdtiqv");
    			set_style(div1, "--imagePath", "url(\"" + /*imagePath*/ ctx[2] + "\")");
    			add_location(div1, file, 21, 2, 420);
    			attr_dev(main, "class", "svelte-1tdtiqv");
    			add_location(main, file, 20, 0, 411);
    		},
    ...
    // (89:2) {#each calendarDays as doorNumber}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(89:2) {#each calendarDays as doorNumber}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 79, 1, 2133);
    			add_location(p0, file$1, 80, 1, 2170);
    			add_location(p1, file$1, 82, 1, 2212);
    			add_location(p2, file$1, 83, 1, 2284);
    			add_location(p3, file$1, 85, 1, 2353);
    			attr_dev(div0, "class", "box svelte-1dpsacs");
    			add_location(div0, file$1, 87, 1, 2380);
    			add_location(p4, file$1, 100, 1, 2727);
    			add_location(p5, file$1, 102, 1, 2926);
    			add_location(div1, file$1, 99, 1, 2720);
    			add_location(button, file$1, 104, 5, 3017);
    			add_location(div2, file$1, 104, 0, 3012);
    			attr_dev(main, "class", "svelte-1dpsacs");
    			add_location(main, file$1, 78, 0, 2125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
