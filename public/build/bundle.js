    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*rewardText*/ ctx[2]);
    			attr_dev(span, "class", "bgSpan svelte-1263e6i");
    			add_location(span, file, 26, 12, 590);
    			attr_dev(div0, "class", "backgroundText svelte-1263e6i");
    			add_location(div0, file, 25, 10, 549);
    			attr_dev(div1, "class", "backgroundPicture svelte-1263e6i");
    			add_location(div1, file, 24, 8, 507);
    			attr_dev(a, "href", /*rewardLink*/ ctx[3]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-1263e6i");
    			add_location(a, file, 23, 6, 461);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	door = new Door({
    			props: {
    				...
    				rewardText: /*doorNumber*/ ctx[9].reward.rewardText,
    				rewardLink: /*doorNumber*/ ctx[9].reward.rewardLink,
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 66, 2, 1669);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*calendarDays*/ 2) door_changes.rewardText = /*doorNumber*/ ctx[9].reward.rewardText;
    			if (dirty & /*calendarDays*/ 2) door_changes.rewardLink = /*doorNumber*/ ctx[9].reward.rewardLink;
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1pwaksw");
    			add_location(h1, file$1, 60, 1, 1442);
    			add_location(p0, file$1, 61, 1, 1469);
    			add_location(p1, file$1, 62, 1, 1505);
    			attr_dev(div, "class", "box svelte-1pwaksw");
    			add_location(div, file$1, 64, 1, 1610);
    			attr_dev(main, "class", "svelte-1pwaksw");
    			add_location(main, file$1, 59, 0, 1434);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
