...
var app = (function () {
    ...
    // (17:2) <Link to="{to}" getProps="{getProps}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:2) <Link to=\\\"{to}\\\" getProps=\\\"{getProps}\\\">",
    		ctx
    	});
    ...
    /* src/routes/changelog.svelte generated by Svelte v3.30.0 */

    const file$3 = "src/routes/changelog.svelte";
